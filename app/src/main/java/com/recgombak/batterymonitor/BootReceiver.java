...
public class BootReceiver extends BroadcastReceiver {
 @Override public void onReceive(Context context, Intent intent) { if (!Prefs.isEnabled(context)) return; start(context,new Intent(context,BatteryBroadcastService.class)); if("tablet".equals(Prefs.getRole(context))) start(context,new Intent(context,LowBatteryVoiceService.class)); }
